...
static void vHandlerTask( void *pvParameters )
{
    ...
    for( ;; )
    {
        ...
        TM_USART_Puts(USART1, "Handler task - Processing event.\r\n" );
    }
}
/*-----------------------------------------------------------*/
...
static void vPeriodicTask( void *pvParameters )
{
    ...
    for( ;; )
    {
        ...
        TM_USART_Puts(USART1, "Periodic task - About to generate an interrupt.\r\n" );
        mainTRIGGER_INTERRUPT();
        TM_USART_Puts(USART1, "Periodic task - Interrupt generated.\r\n\n" );
    }
}
/*-----------------------------------------------------------*/
